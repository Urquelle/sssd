...
#define Asb_Knoten_Art \
    ...
    X(AUSDRUCK_FUNKTION,            15, "Ausdruck Funktion") \
    X(AUSDRUCK_OPTION,              16, "Ausdruck Option") \
    X(AUSDRUCK_SCHABLONE,           17, "Ausdruck Schablone") \
    X(AUSDRUCK_ZERLEGEN,            18, "Ausdruck Zerlegen") \
    \
    ...
    X(ANWEISUNG_FINAL,              48, "Anweisung Final") \
    X(ANWEISUNG_WEICHE,             49, "Anweisung Weiche") \
    X(ANWEISUNG_RES,                50, "Anweisung Res") \
    X(ANWEISUNG_SOLANGE,            51, "Anweisung Solange") \
    X(ANWEISUNG_WEITER,             52, "Anweisung Weiter") \
    X(ANWEISUNG_SPRUNG,             53, "Anweisung Sprung") \
    X(ANWEISUNG_RAUS,               54, "Anweisung Raus") \
    X(ANWEISUNG_MARKIERUNG,         55, "Anweisung Markierung") \
    X(ANWEISUNG_BEDINGTER_SPRUNG,   56, "Anweisung Bedingter Sprung") \
...
protected:
    Asb_Knoten(Art art, Spanne spanne);
...
struct Asb
{
    std::vector<Asb_Knoten *> anweisungen;
};
...
/* ausdruck {{{ */
class Ausdruck : public Asb_Knoten
{
public:
protected:
    Ausdruck(Asb_Knoten::Art art, Spanne spanne);
};
...
#define Bin_Op_Liste \
    ...
    X(BIT_VERSATZ_LINKS,   12, "Bitversatz links") \
    X(BIT_VERSATZ_RECHTS,  13, "Bitversatz rechts")
...
{
public:
    Ausdruck_Eigenschaft(Spanne spanne, Ausdruck *basis, Ausdruck *eigenschaft);
...
class Ausdruck_Funktion : public Ausdruck
{
public:
    Ausdruck_Funktion(Spanne spanne, std::vector<Deklaration *> parameter,
...
class Ausdruck_Schablone : public Ausdruck
{
public:
    Ausdruck_Schablone(Spanne spanne, std::vector<Deklaration *> eigenschaften);
...
class Ausdruck_Option : public Ausdruck
{
public:
    Ausdruck_Option(Spanne spanne, std::vector<Deklaration_Variable *> eigenschaften);
...
class Ausdruck_Zerlegen : public Ausdruck
{
public:
    Ausdruck_Zerlegen(Spanne spanne /*, deklarationen und bezeichner */);
};
/* }}} */
// spezifizierung {{{
class Spezifizierung : public Asb_Knoten
{
public:
    Spezifizierung(Asb_Knoten::Art art, Spanne spanne);
...
// }}}
// deklaration {{{
class Deklaration : public Asb_Knoten
{
public:
    Deklaration(Asb_Knoten::Art art, Spanne spanne, std::vector<std::string> namen);
    Deklaration(Asb_Knoten::Art art, Spanne spanne, std::string name);
...
{
public:
    Deklaration_Funktion(Spanne spanne, std::string name, Spezifizierung *spezifizierung, Ausdruck_Funktion *ausdruck);

    Ausdruck_Funktion * ausdruck() const;
    std::vector<Deklaration *> parameter() const;
    Spezifizierung * rückgabe() const;
    Anweisung * rumpf() const;
...
{
public:
    Deklaration_Option(Spanne spanne, std::string name, Ausdruck_Option *ausdruck);

    Ausdruck_Option * ausdruck() const;
    std::vector<Deklaration_Variable *> eigenschaften() const;

private:
    Ausdruck_Option *_ausdruck;
};
// }}}
/* anweisungen {{{ */
class Anweisung : public Asb_Knoten
{
public:
    Anweisung(Asb_Knoten::Art art, Spanne spanne);
...
class Anweisung_Solange : public Anweisung
{
public:
    Anweisung_Solange(Spanne spanne, Ausdruck *bedingung, Anweisung *rumpf);
...
class Anweisung_Final : public Anweisung
{
public:
    Anweisung_Final(Spanne spanne, Anweisung *anweisung);
...
class Anweisung_Weiter : public Anweisung
{
public:
    Anweisung_Weiter(Spanne spanne);
};

class Anweisung_Sprung : public Anweisung
{
public:
    Anweisung_Sprung(Spanne spanne, Ausdruck_Bezeichner *markierung);

    Ausdruck_Bezeichner * markierung() const;

private:
    Ausdruck_Bezeichner *_markierung;
};

class Anweisung_Raus : public Anweisung
{
public:
    Anweisung_Raus(Spanne spanne);
};

class Anweisung_Markierung : public Anweisung
{
public:
    Anweisung_Markierung(Spanne spanne, std::string markierung);
