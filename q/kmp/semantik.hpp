...
public:
    ...
    void analyse_abschließen();
    void schablone_abschließen(Deklaration_Schablone *schablone);
    void datentyp_abschließen(Datentyp *datentyp);
    ...
    void       anweisung_analysieren(Anweisung *anweisung);
    ...
    bool datentypen_kompatibel(Datentyp *links, Datentyp *rechts);
    bool operanden_kompatibel(Operand *links, Operand *rechts);
